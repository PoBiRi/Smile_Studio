        ...
        >
            <g id="주황색그림자smile">
                ...
                <circle
                    id="i점"
                    className="p"
                    cx="249.59" cy="80.77" r="7.87"
                />
            </g>
            <g id="주황색 그림자 sound">
                <path
                    className="q"
                    d="M114.36,237.46c0,4.21-3.94,8.05-9.98,8.05-3.29,0-6.31-.92-7.87-2.1-2.38-1.74-.41-4.85,1.83-3.8,1.42.69,3.29,1.6,5.95,1.6,3.34,0,5.03-1.46,5.03-3.66,0-5.17-14.32-3.29-14.32-12.26,0-4.21,3.98-8.01,9.98-8.01,3.66,0,5.49.92,7,2.06,2.33,1.69.05,5.22-1.97,3.71-1.24-.92-2.33-1.51-5.03-1.51-3.29,0-4.94,1.46-4.94,3.66,0,5.22,14.32,3.34,14.32,12.26Z"
                />
                <path
                    className="q"
                    d="M126.3,245.52c-5.17,0-9.47-3.98-9.47-9.7s4.3-9.7,9.47-9.7,9.47,3.98,9.47,9.7-4.3,9.7-9.47,9.7ZM126.3,230.46c-2.56,0-4.67,2.01-4.67,5.35s2.1,5.35,4.67,5.35,4.67-2.01,4.67-5.35-2.11-5.35-4.67-5.35Z"
                />
                <path
                    className="q"
                    d="M146.99,245.52c-5.13,0-8.19-3.61-8.19-9.75l-.09-7.23c0-2.84,5.03-3.2,5.03-.05l.14,7.28c0,3.75,1.28,5.4,3.16,5.4,2.52,0,5.58-3.16,5.58-7.64l.05-5.35c.18-2.75,5.03-2.43,4.99.27l-.09,15.01c.05,2.65-4.71,2.56-4.71,0v-1.46c-1.01,1.92-3.34,3.52-5.86,3.52Z"
                />
                <path
                    className="q"
                    d="M165.84,243.05c-.05,2.79-4.76,2.47-4.67-.23l.09-15.19c0-2.61,4.48-2.7,4.48.14v1.83c.96-2.06,2.97-4.16,5.67-4.16,5.22,0,7.55,3.57,7.55,9.75l.09,7.55c0,2.84-4.76,3.16-4.76.05l-.14-7.6c0-3.11-.87-5.77-2.79-5.45-2.75.41-5.54,5.03-5.54,9.56v3.75Z"
                />
                <path
                    className="q"
                    d="M199.25,219.85c.14,5.49,0,14.78-.09,23.66,0,2.65-4.67,2.29-4.67.69v-1.1c-.78,1.37-2.52,1.97-3.75,1.97-4.62,0-8.74-3.25-8.74-9.29,0-5.31,4.07-9.11,8.79-9.11,1.56,0,2.88.73,3.61,1.74,0-2.61,0-5.13-.05-8.69-.09-2.7,4.9-2.56,4.9.14ZM194.4,235.36c-.23-3.02-1.78-4.39-3.66-4.39-2.1,0-3.66,1.88-3.66,4.8,0,3.48,1.6,5.03,3.66,5.03,1.88,0,3.29-1.56,3.62-4.07l.05-1.37Z"
                />
            </g>
            <g id="주황색 그림자 studio">
                <path
                    className="q"
                    d="M227.82,237.46c0,4.21-3.94,8.05-9.98,8.05-3.29,0-6.31-.92-7.87-2.1-2.38-1.74-.41-4.85,1.83-3.8,1.42.69,3.29,1.6,5.95,1.6,3.34,0,5.03-1.46,5.03-3.66,0-5.17-14.32-3.29-14.32-12.26,0-4.21,3.98-8.01,9.98-8.01,3.66,0,5.49.92,7,2.06,2.33,1.69.05,5.22-1.97,3.71-1.24-.92-2.33-1.51-5.03-1.51-3.29,0-4.94,1.46-4.94,3.66,0,5.22,14.32,3.34,14.32,12.26Z"
                />
                <path
                    className="q"
                    d="M233.35,228.4l-1.65.05c-1.33.05-2.01-.96-2.01-2.06,0-1.01.69-2.15,1.97-2.15l1.69-.05.05-3.75c0-2.97,4.62-3.25,4.62.27l-.05,3.34,2.79-.09c1.33,0,2.1,1.05,2.15,2.06.09,1.14-.73,2.1-2.1,2.15l-2.88.09-.17,11.56c0,2.06,2.62,1.05,4.32.92,2.47-.18,3.39,3.98.14,4.39-3.29.37-8.98.5-8.98-5.22l.13-11.51Z"
                />
                <path
                    className="q"
                    d="M255.78,245.52c-5.13,0-8.19-3.62-8.19-9.75l-.09-7.23c0-2.84,5.03-3.2,5.03-.05l.14,7.28c0,3.75,1.28,5.4,3.16,5.4,2.52,0,5.58-3.16,5.58-7.64l.05-5.35c.18-2.75,5.03-2.42,4.99.28l-.09,15.01c.05,2.65-4.71,2.56-4.71,0v-1.46c-1.01,1.92-3.34,3.52-5.86,3.52Z"
                />
                <path
                    className="q"
                    d="M286.66,219.85c.14,5.49,0,14.78-.09,23.66,0,2.65-4.67,2.29-4.67.69v-1.1c-.78,1.37-2.52,1.97-3.75,1.97-4.62,0-8.74-3.25-8.74-9.29,0-5.31,4.07-9.11,8.79-9.11,1.56,0,2.88.73,3.61,1.74,0-2.61,0-5.13-.05-8.69-.09-2.7,4.9-2.56,4.9.14ZM281.81,235.36c-.23-3.02-1.78-4.39-3.66-4.39-2.1,0-3.66,1.88-3.66,4.81,0,3.48,1.6,5.03,3.66,5.03,1.88,0,3.29-1.55,3.62-4.07l.05-1.37Z"
                />
                <circle
                    className="q"
                    cx="293.68" cy="221.06" r="3.34"
                />
                <path
                    className="q"
                    d="M296.05,229.55c.23,5.45.18,10.25.18,13.73,0,2.47-4.94,2.33-4.94-.41.09-3.2,0-7.92-.09-13.45-.09-2.65,4.81-2.61,4.85.14Z"
                />
                <path
                    className="q"
                    d="M309.45,245.52c-5.17,0-9.47-3.98-9.47-9.7s4.3-9.7,9.47-9.7,9.47,3.98,9.47,9.7-4.3,9.7-9.47,9.7ZM309.45,230.46c-2.56,0-4.67,2.01-4.67,5.35s2.11,5.35,4.67,5.35,4.67-2.01,4.67-5.35-2.1-5.35-4.67-5.35Z"
                />
                <circle
                    className="q"
                    cx="324.47" cy="242.96" r="3.34"
                />
            </g>
            <g id="큰글씨">
                <path
                    id="주황색 사선"
                    className="j"
                    d="M148.84,45.46c3.98-7.7,8.88-17.45,6.45-24.7-3.73-11.09-11.75-15.84-21.69-14.72-16.65,1.77-27.53,18.65-30.12,34.92-3.88,23.99-.68,52.21,13.35,71.86"
                />
                <path
                    id="노란색 그림자1"
                    className="m"
                    d="M141.88,63.27c-3.36,8.06-9.99,14.73-16.15,20.08s-12.26,9.06-18.77,13.97-10.14,10.32-12.33,18.17c-3.09,11.07,2.68,23.64,12.55,29.52,4.94,2.94,10.66,4.27,16.4,4.16"
                />
                <path
                    id="노란색 그림자2"
                    className="m"
                    d="M123.59,149.17c5.74-.11,11.5-1.67,16.5-4.51,7.23-4.1,13.21-13.49,13.66-21.8s-2.54-15.2-10.86-14.94c-1.37.04-3.25.55-5.2,1.36"
                />
                <path
                    id="노란색 그림자3"
                    className="m"
                    d="M137.7,109.29c-3.96,1.63-8.22,4.47-9.2,7.08-1.47,3.89,1.29,7.42,5.14,8.97,2.01-2.25-.67-6.53-3.57-5.71"
                />
                <circle
                    id="주황색 i"
                    className="q"
